...
Alongside the pages, every build writes eight files of its own: `state.json` (above), `tokens.css`,
`order.js`, `deploy.js`, `approve.js`, `refresh.js` and `action-modal.js` copied from the theme, and
